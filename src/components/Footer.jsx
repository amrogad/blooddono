    ...
    <div className="border-t border-line bg-card">
      <div className="mx-auto flex max-w-[1600px] flex-col items-center gap-6 px-8 py-12 md:flex-row md:justify-between md:gap-4">
        ...
        <div className="flex items-center gap-4 text-muted">
          <a href="#" aria-label="Facebook" className="transition-colors hover:text-crimson">
            <svg width="20" height="20" viewBox="0 0 24 24" className="fill-current" aria-hidden="true">
              <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
            </svg>
          </a>
          <a href="#" aria-label="YouTube" className="transition-colors hover:text-crimson">
            <svg width="20" height="20" viewBox="0 0 24 24" className="fill-current" aria-hidden="true">
              <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" />
            </svg>
          </a>
          <a href="#" aria-label="Twitter" className="transition-colors hover:text-crimson">
            <svg width="20" height="20" viewBox="0 0 24 24" className="fill-current" aria-hidden="true">
