      ...
      <div className="max-w-[1600px] mx-auto p-4 lg:px-[10px]">
        <div className="flex flex-col-reverse lg:flex-row justify-center items-center">
          <div className="flex flex-col justify-center items-center gap-20 mt-20 w-full lg:w-1/2">
            ...
            <h2 className="font-bold text-4xl lg:text-5xl">Page Not Available!</h2>
            <p className="font-semibold text-2xl text-[#333333]">
              Sorry, this page isn't available <br /> anymore or an error occurred.
            </p>
            <p className="font-semibold text-3xl">
              Please Go to{' '}
              <Link
                className="border-b-2 border-green-500 hover:border-green-500 hover:text-white hover:bg-green-500"
                to="/"
              >
                Home
              </Link>{' '}
