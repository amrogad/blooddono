...
const BlogDetails = () => {
  ...
  if (!blog) {
    return (
      <div className="mx-auto max-w-2xl px-6 py-20 text-center">
        <h1 className="font-display text-2xl font-semibold text-ink">{t('content.notFound')}</h1>
        <button
  ...
  return (
    <article className="mx-auto max-w-2xl px-6 py-8">
      ...
      <h1
        dir="auto"
        className="mt-5 font-display text-[32px] font-semibold leading-tight tracking-tight text-ink"
      >
        {blog.title}
      </h1>
      {blog.thumbnail && (
